...
//                System.out.println(this);
    ...
    public void open(String fileName) throws IOException
    {
        ...
        try
        {
            is = new DataInputStream(new BufferedInputStream(
                    IOUtils.newInputStream(fileName), BUF_SIZE));
    ...
    public boolean save(String fileName)
    {
        ...
        try
        {
            out = new DataOutputStream(new BufferedOutputStream(IOUtils.newOutputStream(fileName)));
            out.writeInt(size);
            for (int i = 0; i < size; i++)
            {
                out.writeInt(base[i]);
    ...
    public boolean serializeTo(String path)
    {
        ...
        try
        {
            out = new ObjectOutputStream(IOUtils.newOutputStream(path));
